...
def get_vol_details(xbeans,hostsource,epoch_time):
	...
	with open('/tmp/voldetails.tmp', 'w') as fp:
        # fp.write(nodedata)
		json.dump(yjson, fp)

	shutil.copyfile("/tmp/voldetails.tmp", "/tmp/voldetails")
...
def main():
	...
	get_vol_details(beans, server, epoch_time)
